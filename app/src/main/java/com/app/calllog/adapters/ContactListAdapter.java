package com.app.calllog.adapters;
...
import com.app.calllog.adapters.ContactViewHolder;
...
public class ContactListAdapter extends RecyclerView.Adapter<ContactViewHolder> {
    ...
    private final ArrayList<LineItem> mItems = null;
    ...
    public ContactListAdapter(Context context, int headerMode) {
        mContext = context;
